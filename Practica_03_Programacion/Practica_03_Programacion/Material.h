...
public:
	...
	inline Color GetAmbientColor() const { return this->ambientColor; }
		...
		inline void SetAmbientColor(const Color & ambientColorToSet)
		{
			...
			cout << this->ambientColor.GetRedComponent() << "," << this->ambientColor.GetGreenComponent() <<
				"," << this->ambientColor.GetBlueComponent() << endl;
		}
		...
		inline void SetDiffuseColor(const Color & diffuseColorToSet)
		{
			...
			cout << this->diffuseColor.GetRedComponent() << "," << this->diffuseColor.GetGreenComponent() << "," << this->diffuseColor.GetBlueComponent() << endl;
		}
